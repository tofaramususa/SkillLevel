	...
	return (
		<Container className="pt-[6.4rem]">
			...
			<HeroTitle className="animate-fade-in [--animation-delay:200ms] opacity-0 translate-y-[-1rem]">
					It's time to change what your children 
						<br className="hidden md:block" />are consuming on screens
					</HeroTitle>
					...
					<HeroTitle className="animate-fade-in [--animation-delay:200ms] opacity-0 translate-y-[-1rem]">
					Join our waitlist.
						<br className="hidden md:block" /> Be the first to access our skill-building platform
					</HeroTitle>
